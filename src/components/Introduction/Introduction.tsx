...
export function Introduction() {
    return (
        <div className="bg-[#1e40af]/60 w-full z-10">
                ...
                <div className="container grid items-center h-full px-5 mx-auto md:grid-cols-2 md:text-left">
                    ...
                    >
                        <h1 className="mb-5 text-4xl leading-tight md:mb-10">Si puedes pensarlo,  <br />
                            <span className="text-teal-500">puedes programarlo</span></h1>
                        ...
                        <div className="flex flex-col items-center gap-3 md:gap-10 md:flex-row">
                            ...
                            <a href="/contact" className="px-6 py-3 my-2 transition-all border-2 cursor-pointer text-teal-500 border-teal-500 rounded-xl hover:shadow-xl hover:shadow-teal-500">
                                Contacta conmigo
                            </a>
                        </div>
                    </motion.div>
